...
import com.app.spark.photoeditor.Utils.InfinitePagerAdapter;
import com.app.spark.photoeditor.Utils.InfiniteViewPager;
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup collection, int position) {
            ...
            if (position == 0) {
              ...
              //  setFilterEffectVideo(PhotoFilter.DOCUMENTARY);
            } else if (position == 2) {
                viewBG.setVisibility(GONE);
                ivBottom.setVisibility(VISIBLE);
                ivBottom.setImageDrawable(getResources().getDrawable(R.drawable.dummy_emojy));
                mImageFilterView.setFilterEffect(PhotoFilter.DUE_TONE);
               // setFilterEffectVideo(PhotoFilter.DUE_TONE);
            } else if (position == 3) {
                viewBG.setVisibility(VISIBLE);
                ivBottom.setImageDrawable(getResources().getDrawable(R.drawable.dummy_image));
                ivBottom.setVisibility(VISIBLE);
                mImageFilterView.setFilterEffect(PhotoFilter.FISH_EYE);
              //  setFilterEffectVideo(PhotoFilter.FISH_EYE);
            }else if (position == 4) {
                viewBG.setVisibility(VISIBLE);
                ivBottom.setImageDrawable(getResources().getDrawable(R.drawable.dummy_emojy));
                ivBottom.setVisibility(VISIBLE);
                mImageFilterView.setFilterEffect(PhotoFilter.NEGATIVE);
                // setFilterEffectVideo(PhotoFilter.NEGATIVE);
            }
