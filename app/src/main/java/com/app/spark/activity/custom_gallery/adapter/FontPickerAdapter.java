...
public class FontPickerAdapter extends RecyclerView.Adapter<FontPickerAdapter.ViewHolder> {
    ...
    public FontPickerAdapter(@NonNull Context context, int selectedPos, @NonNull List<String> fontPickerFonts, List<Integer> fontIds) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (selectedPos == i)
            viewHolder.name.setBackgroundColor(ContextCompat.getColor(context, R.color.red_F94757));
        else {
            viewHolder.name.setBackgroundColor(ContextCompat.getColor(context, R.color.transparent));
        }
    }
                ...
                public void onClick(View v) {
                    if (getAdapterPosition() != selectedPos) {
                        if (onFontSelectListner != null) {
                            ...
                            name.setBackgroundColor(ContextCompat.getColor(context, R.color.red_F94757));
   ...
   public interface OnFontSelectListner {
