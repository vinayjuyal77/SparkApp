...
class ProfessionalFollowingAdaptor2(
        var context: Context, val list: MutableList<ResultFollowing>, val listner: ProfessionalFragment

) :
    RecyclerView.Adapter<ProfessionalFollowingAdaptor2.ViewHolder>() {
