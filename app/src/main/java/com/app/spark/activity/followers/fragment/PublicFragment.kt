...
import com.app.spark.activity.followers.PublicFollowingAdaptor2
import com.app.spark.activity.followers.viewmodel.PersonalFollowersViewModel
...
import com.app.spark.databinding.FragmentPersonalBinding
import com.app.spark.databinding.FragmentPublicBinding
...
class PublicFragment : Fragment(),
    ...
    private lateinit var viewModel: PersonalFollowersViewModel
    private lateinit var followingAdaptor2: PublicFollowingAdaptor2
    private lateinit var layoutManager: GridLayoutManager
    lateinit var list: ArrayList<ResultFollowing>


    private var type: String = "followers"
    var connectionType = "public"
    ...
    override fun onCreateView(
        ...
        ).get(PersonalFollowersViewModel::class.java)
        return binding.root
...
//        }
    ...
    private fun inItAdaptor() {
        followingAdaptor2 = PublicFollowingAdaptor2(context!!, followingList, this)
