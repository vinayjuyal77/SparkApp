...
class PublicFollowingAdaptor2(
    var context: Context, val list: MutableList<ResultFollowing>, val listner: PublicFragment

) :
    RecyclerView.Adapter<PublicFollowingAdaptor2.ViewHolder>() {
