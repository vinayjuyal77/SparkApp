    ...
    inner class ViewHolder(var binding: ItemGalleryBinding) :
        ...
        fun bindData(
            ...
            if (item.mediaType == "photo") {
                Glide.with(context).load(item.postMedia).placeholder(R.drawable.ic_baseline_info_24)
