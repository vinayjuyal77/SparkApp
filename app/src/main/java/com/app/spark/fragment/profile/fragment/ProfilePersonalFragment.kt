...
import com.app.spark.databinding.FragmentProfilePersonalBinding
 ...
 * Use the [ProfilePersonalFragment.newInstance] factory method to
...
class ProfilePersonalFragment : Fragment() {
    ...
    lateinit var binding: FragmentProfilePersonalBinding
    ...
    private lateinit var profiliefeedadapterPersonal: ProfilePersonalFeedAdapter
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_profile_personal, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        profiliefeedadapterPersonal =
            ProfilePersonalFeedAdapter(requireActivity(), list, loginId, "personal")
    ...
    private fun observeProfile() {
        viewModel.response.observe(viewLifecycleOwner, Observer {
            ...
            setPostFeeds(it.result.personalArr)

            var list: List<ProfileGetResponse.ResultProfile.PostArr>?
            list = ArrayList()
            list = it.result.personalArr

            for (i in 0 until list.size) {


//                if (list.get(i).mediaType.equals("photo")) {
//                    DownloadTask(requireContext(), list[i].postMedia)
//
//
//                } else if (list[i].mediaType.equals("video")) {
//
//                    DownloadTask(requireContext(), list[i].postMedia)
//                }
