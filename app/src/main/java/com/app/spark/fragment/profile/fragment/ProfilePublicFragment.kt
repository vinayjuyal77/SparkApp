...
import com.app.spark.databinding.FragmentProfilePublicBinding
...
import com.app.spark.fragment.profile.ProfilePublicFeedAdapter
 ...
 * Use the [ProfilePublicFragment.newInstance] factory method to
...
class ProfilePublicFragment :  Fragment() {
    ...
    lateinit var binding: FragmentProfilePublicBinding
    ...
    private lateinit var profiliefeedadapterPersonal : ProfilePublicFeedAdapter
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_profile_public, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        profiliefeedadapterPersonal  = ProfilePublicFeedAdapter(requireActivity(), list, loginId, "")
