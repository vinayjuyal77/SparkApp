...
class ConversationListAdapter(
    ...
    inner class ViewHolder(var binding: ItemCoversationListBinding) :
        ...
        fun bindData(
            ...
            Glide.with(context).load(item.profilePic).placeholder(R.drawable.ic_profile).error(R.drawable.ic_profile)
            ...
            binding.imgProfilePic.setOnClickListener {
                ChatProfileDialog(context,item.profilePic,item.name, object : ChatProfileDialogListner{
