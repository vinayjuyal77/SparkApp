...
import com.app.spark.databinding.ItemFlicksVideoViewBinding
...
class FlicksNewVideoViewAdapter2(
  ...
  ///  var exoPlayer = SimpleExoPlayer.Builder(context).build()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        var binding: ItemFlicksVideoViewBinding
        var binding2: ItemAddsFlickBinding
        if (viewType == FLICK_LAYOUT) {
            binding = DataBindingUtil.inflate(
                LayoutInflater.from(context),
                R.layout.item_flicks_video_view,
                parent,
                false
            )
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is FlicksNewVideoViewAdapter2.ViewHolder -> holder.bindData(
                list[position],
                position,
                itemInterface
            )
            is FlicksNewVideoViewAdapter2.ViewHolder2 -> holder.bindData(
                list[position],
                position,
                itemInterface
            )
    ...
    inner class ViewHolder(var binding: ItemFlicksVideoViewBinding) :
...
//            requestOptions.isMemoryCacheable
           ...
           //  binding.imgPost.fadeOut_image(500)
         //   setPlayerVideoview(item.flickMedia, binding.pvVideo, binding.imgPost)


           // binding.pvVideo.setVideoPath(item.flickMedia)
...
//                shapeableImageView.visibility = View.GONE
                it.start()
                shapeableImageView.fadeOut_image(400)
...
//                            )
                            ...
                            //  setPlayerVideoview("http://15.206.254.159/app/uploads/flick/1625837746657.mp4",binding.pvVideo, binding.impost )
...
//                shapeableImageView.visibility = View.GONE
            ...
            //    shapeableImageView.visibility = View.INVISIBLE
                  ...
                  // var video_ration = it.videoWidth / it.videoHeight
//                   var video_ration =context.windowManager.defaultDisplay.width / context.windowManager.defaultDisplay.height
//                 var screen_ratio = videoView.width / videoView.height
//
//                var scale = video_ration / screen_ratio
//                if(scale >= 1f)
//                {
//
...
//                else
//                {
//                    videoView.scaleY = 1f / scale.toFloat()
//
//                }
