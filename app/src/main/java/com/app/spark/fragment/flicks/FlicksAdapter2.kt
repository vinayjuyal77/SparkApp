...
class FlicksAdapter2(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder) {
            is FlicksAdapter2.ViewHolder -> holder.bindData(list[position], position, itemInterface)
            is FlicksAdapter2.ViewHolder2 -> holder.bindData(list[position], position, itemInterface)
    ...
    inner class ViewHolder2(var binding: ItemAddsFlickBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bindData(
            item: GetFlickResponse.Result,
            position: Int,
            itemInterface: OnFeedSelectedInterface?
...
//                        binding.nativeTemplateView?.setNativeAd(unifiedNativeAd)
//                        ///     adLoaded = true
////                        Toast.makeText(
////                            context,
