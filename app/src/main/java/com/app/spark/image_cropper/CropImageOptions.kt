 ...
 * Initialized with default @JvmField @JvmField @JvmField values.
 */
...
//        aspectRatioY = `in`.readInt()
        ...
        outputUri =
            `in`.readParcelable(Uri::class.java.classLoader)
        ...
        outputRequestSizeOptions =
            RequestSizeOptions.values()[`in`.readInt()]
        noOutputImage = `in`.readByte().toInt() != 0
        initialCropWindowRectangle =
            `in`.readParcelable(Rect::class.java.classLoader)
        ...
        val CREATOR: Parcelable.Creator<CropImageOptions?>? =
            object : Parcelable.Creator<CropImageOptions?> {
                ...
                override fun newArray(size: Int): Array<CropImageOptions?>? {
                    return arrayOfNulls<CropImageOptions?>(size)
                }
            }
    }*/
