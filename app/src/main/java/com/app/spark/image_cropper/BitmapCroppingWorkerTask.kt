...
import com.app.spark.image_cropper.BitmapUtils
import com.app.spark.image_cropper.BitmapUtils.BitmapSampled
...
internal class BitmapCroppingWorkerTask :
    ...
    constructor(
        ...
        mContext = WeakReference(cropImageView?.context)
        mBitmap = bitmap
            ...
            if (!isCancelled) {
                ...
                return if (mSaveUri == null) {
                    ...
                    BitmapUtils.writeBitmapToUri(
                        mContext?.get(), bitmap, mSaveUri, mSaveCompressFormat, mSaveCompressQuality
                    )
                    bitmap?.recycle()
                    Result(
                        mSaveUri,
