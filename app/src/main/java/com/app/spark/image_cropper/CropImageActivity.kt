...
import com.app.spark.image_cropper.CropImage
import com.app.spark.image_cropper.CropImageOptions
...
class CropImageActivity : AppCompatActivity(), OnSetImageUriCompleteListener,
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (actionBar != null) {
            val title: CharSequence =
                ...
                ) mOptions!!.activityTitle else resources.getString(R.string.crop_image_activity_title))!!
    ...
    private fun getOutputUri(): Uri? {
        ...
        if (outputUri == null || outputUri == Uri.EMPTY) {
            outputUri = try {
                val ext =
                    if (mOptions!!.outputCompressFormat === CompressFormat.JPEG) ".jpg" else if (mOptions!!.outputCompressFormat === CompressFormat.PNG) ".png" else ".webp"
                Uri.fromFile(
                    File.createTempFile(
                        "cropped",
                        ext,
    ...
    private fun updateMenuItemIconColor(
        menu: Menu?,
        itemId: Int,
        color: Int
    ) {
