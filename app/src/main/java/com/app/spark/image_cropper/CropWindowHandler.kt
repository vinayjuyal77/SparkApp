...
internal class CropWindowHandler {
    ...
    fun getMoveHandler(
        ...
        val type: CropWindowMoveHandler.Type? =
        ...
        return if (type != null) {
            CropWindowMoveHandler(type, this, x, y)
        } else {
            null
        }
    }
