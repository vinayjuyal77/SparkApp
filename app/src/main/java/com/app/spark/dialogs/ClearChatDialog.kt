...
import com.app.spark.databinding.DialogClearChatBinding
...
class ClearChatDialog(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.dialog_clear_chat, null, false)
    ...
    private fun setClickListener(){
        ...
        binding.cbDeleteStarMsg.setOnCheckedChangeListener { _, b ->
            if (b){
                selectedTime="3"
            }
        }
