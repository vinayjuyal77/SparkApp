...
class BlockChatDialog(
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.dialog_block_chat, null, false)
    ...
    private fun setClickListener(){
        binding.tvOk.setOnClickListener {
            onConnectionTypeSelected.onSelectedConnection("1")
            dismiss()
        }
