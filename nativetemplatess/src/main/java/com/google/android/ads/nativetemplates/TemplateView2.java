...
public class TemplateView2 extends FrameLayout {
  ...
  public TemplateView2(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    initView(context, attrs);
  }

  public TemplateView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    initView(context, attrs);
  }

  public TemplateView2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
  ...
  private void initView(Context context, AttributeSet attributeSet) {
    ...
    TypedArray attributes =
        context.getTheme().obtainStyledAttributes(attributeSet, R.styleable.TemplateView2, 0, 0);

    try {
      templateType =
          attributes.getResourceId(
              R.styleable.TemplateView2_gnt_template_type2, R.layout.gnt_medium_template_view_flick);
    } finally {
      attributes.recycle();
    }
